...
/**
 * {@link Logger} proxy handler. This handler is used to handle changing {@link LogManagerProvider}
 * This can happen, when the logging backend (log4j-core) changes during runtime. So, as long a the log4j-api does not change,
 * The components will not modified, an the change happens silently in the background.
