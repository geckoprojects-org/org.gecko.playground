...
/**
 * This interface is a delegate service interface equal to the {@link LogManager}.
 * Because in Log4J the {@link LogManager} is a singleton, that tries to handle OSGi and non-OSGi 
 * initialization, we use this interface to implement the pure OSGi way
...
public interface LogManagerProvider {
	...
	public static final String CAPABILITY_NAMESPACE = "gecko.logging";
	public static final String LOGGING_LOG4J = "logging.log4j";
