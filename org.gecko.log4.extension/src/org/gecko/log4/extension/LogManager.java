...
public class LogManager implements LogManagerProvider {
    ...
    private volatile LoggerContextFactory factory;
     ...
     */
    public LogManager(Provider provider) {
...
//                for (final Provider provider : ProviderUtil.getProviders()) {
                    ...
                    if (factoryClass != null) {
                        try {
                        	LoggerContextFactory instance = (LoggerContextFactory) factoryClass.getConstructors()[0].newInstance();
                            factories.put(provider.getPriority(), instance);
