...
import org.gecko.playground.model.person.*;
 ...
 * <!-- end-user-doc -->
 * @see org.gecko.playground.model.person.PersonPackage
 * @generated
 */
public class PersonSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case PersonPackage.ADDRESS_BOOK: {
