...
public class PersonFactoryImpl extends EFactoryImpl implements PersonFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case PersonPackage.ADDRESS_BOOK: return createAddressBook();
			case PersonPackage.CONTACT: return createContact();
			case PersonPackage.TAG: return createTag();
			default:
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			case PersonPackage.CONTEXT_TYPE:
				return createContextTypeFromString(eDataType, initialValue);
			case PersonPackage.CONTACT_TYPE:
